...
- **2026-09-24 — CI exports a debug-signed APK when no release secret exists.** A release keystore must never be committed; the workflow documents the `ANDROID_KEYSTORE_*` secret path for a future protected release build.
